...
from eomas_assistant.nodes.geography import DEFAULT_ZOOM_LEVEL, GeographyAgent, GeographyExtraction
...
def test_geography_agent_extracts_location_bbox_and_time_range(mocker) -> None:
    ...
    mocker.patch(
        "eomas_assistant.nodes.geography.llm_helper.call_llm_with_schema",
        side_effect=[
            GeographyExtraction(

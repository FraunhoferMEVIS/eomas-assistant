...
def list_available_stac_asset_keys() -> dict:
    ...
    return {
        ...
        "assets": [
            ...
            {"key": "AOT_20m", "title": "Aerosol optical thickness (AOT) - 20m"},
            {"key": "AOT_60m", "title": "Aerosol optical thickness (AOT) - 60m"},
            {"key": "B01_20m", "title": "Coastal aerosol (band 1) - 20m"},
            {"key": "B01_60m", "title": "Coastal aerosol (band 1) - 60m"},
            {"key": "B02_10m", "title": "Blue (band 2) - 10m"},
            {"key": "B02_20m", "title": "Blue (band 2) - 20m"},
            {"key": "B02_60m", "title": "Blue (band 2) - 60m"},
            {"key": "B03_10m", "title": "Green (band 3) - 10m"},
            {"key": "B03_20m", "title": "Green (band 3) - 20m"},
            {"key": "B03_60m", "title": "Green (band 3) - 60m"},
            {"key": "B04_10m", "title": "Red (band 4) - 10m"},
            {"key": "B04_20m", "title": "Red (band 4) - 20m"},
            {"key": "B04_60m", "title": "Red (band 4) - 60m"},
            {"key": "B05_20m", "title": "Red edge 1 (band 5) - 20m"},
            {"key": "B05_60m", "title": "Red edge 1 (band 5) - 60m"},
            {"key": "B06_20m", "title": "Red edge 2 (band 6) - 20m"},
            {"key": "B06_60m", "title": "Red edge 2 (band 6) - 60m"},
            {"key": "B07_20m", "title": "Red edge 3 (band 7) - 20m"},
            {"key": "B07_60m", "title": "Red edge 3 (band 7) - 60m"},
            {"key": "B08_10m", "title": "NIR 1 (band 8) - 10m"},
            {"key": "B09_60m", "title": "NIR 3 (band 9) - 60m"},
            {"key": "B11_20m", "title": "SWIR 1 (band 11) - 20m"},
            {"key": "B11_60m", "title": "SWIR 1 (band 11) - 60m"},
            {"key": "B12_20m", "title": "SWIR 2 (band 12) - 20m"},
            {"key": "B12_60m", "title": "SWIR 2 (band 12) - 60m"},
            {"key": "B8A_20m", "title": "NIR 2 (band 8A) - 20m"},
            {"key": "B8A_60m", "title": "NIR 2 (band 8A) - 60m"},
            {"key": "CLD_20m", "title": "Cloud probability (CLD) - 20m"},
            {"key": "CLD_60m", "title": "Cloud probability (CLD) - 60m"},
            {"key": "SCL_20m", "title": "Scene classification map (SCL) - 20m"},
            {"key": "SCL_60m", "title": "Scene classification map (SCL) - 60m"},
            {"key": "SNW_20m", "title": "Snow probability (SNW) - 20m"},
            {"key": "SNW_60m", "title": "Snow probability (SNW) - 60m"},
            {"key": "TCI_10m", "title": "True color image"},
            {"key": "TCI_20m", "title": "True color image"},
            {"key": "TCI_60m", "title": "True color image"},
            {"key": "WVP_10m", "title": "Water vapour (WVP) - 10m"},
            {"key": "WVP_20m", "title": "Water vapour (WVP) - 20m"},
            {"key": "WVP_60m", "title": "Water vapour (WVP) - 60m"},
        ],
